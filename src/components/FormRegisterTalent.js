...
class FormRegisterTalent extends Component {
  render () {
    const { fullName, email, phoneNumber, password, confirmPassword, changeFullName, changeEmail, changePhoneNumber, changePassword, changeConfirmPassword, onRegister } = this.props
    return (
      <React.Fragment>
